...
CREATE VIEW IF NOT EXISTS complete_org_activities AS select org_activities.id,organization_name,project_name,role from organizations RIGHT JOIN org_activities on organizations.id=org_activities.org_id;