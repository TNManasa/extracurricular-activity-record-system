...
CREATE PROCEDURE InsertOrganizationActivity(var_student_id VARCHAR(7),var_activity_type TINYINT,var_start_date DATE,var_end_date VARCHAR(10),var_effort INT,var_description TEXT,var_image TINYINT,var_org_id TINYINT,var_role VARCHAR(30),var_project_name VARCHAR(30),OUT success TINYINT)
  BEGIN
	DECLARE id INT;
